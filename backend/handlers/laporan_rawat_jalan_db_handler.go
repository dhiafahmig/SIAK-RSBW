...
// LaporanRawatJalanDBHandler menangani permintaan untuk mendapatkan laporan rawat jalan dari database MySQL
func LaporanRawatJalanDBHandler(w http.ResponseWriter, r *http.Request) {
